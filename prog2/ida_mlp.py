...
def is_solved(puzzle_state, solved_puzzle):
    ...
    # temp = np.array([[  6.,   4.,  10.,  20.,   1.,  21.,  11.,   0.,   0.,   0.,   0.,
    #       0.],
    #    [ 99.,  16.,  19.,   7.,   5.,   3.,   0.,   0.,   0.,   0.,   0.,
    #      99.],
    #    [ 99.,  99.,   2.,   9.,  14.,   0.,   0.,   0.,   0.,   0.,  99.,
    #      99.],
    #    [ 99.,  99.,  99.,   8.,  17.,  13.,   0.,   0.,   0.,  99.,  99.,
    #      99.],
    #    [ 99.,  99.,  99.,  99.,  18.,  15.,   0.,   0.,  99.,  99.,  99.,
    #      99.],
    #    [ 99.,  99.,  99.,  99.,  99.,  12.,   0.,  99.,  99.,  99.,  99.,
    #      99.]])
    # pdb.set_trace()
    verify_correctness = []
    for i in range(6):
